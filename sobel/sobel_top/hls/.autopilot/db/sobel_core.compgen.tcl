...
set name sobel_top_mul_32s_32s_32_5_1
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler sobel_top_sobel_core_linebuf0_RAM_1P_BRAM_2R1W BINDTYPE {storage} TYPE {ram_1p} IMPL {bram} LATENCY 3 ALLOW_PRAGMA 1
}
