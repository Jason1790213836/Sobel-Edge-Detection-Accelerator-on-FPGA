...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "sobel_top.autotvin.dat"
	set constFileTvOut       "sobel_top.autotvout.dat"
	set constFileHdlTvIn     "sobel_top.autohdltvin.dat"
	set constFileHdlTvOut    "sobel_top.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
