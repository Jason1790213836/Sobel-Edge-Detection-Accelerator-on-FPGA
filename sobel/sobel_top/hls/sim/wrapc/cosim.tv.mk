...
$(ObjDir)/sobel_ref.cpp_pre.cpp.tb.o : sobel_ref.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling sobel_ref.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN} -std=gnu++17 -fno-builtin-isinf -fno-builtin-isnan -c  $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/window_generator.cpp_pre.cpp.tb.o : window_generator.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling window_generator.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN} -std=gnu++17 -fno-builtin-isinf -fno-builtin-isnan -c  $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/sobel_top.cpp_pre.cpp.tb.o : sobel_top.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling sobel_top.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN} -std=gnu++17 -fno-builtin-isinf -fno-builtin-isnan -c  $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/sobel_core.cpp_pre.cpp.tb.o : sobel_core.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling sobel_core.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN} -std=gnu++17 -fno-builtin-isinf -fno-builtin-isnan -c  $(IFLAG) $(DFLAG) $< -o $@; \
