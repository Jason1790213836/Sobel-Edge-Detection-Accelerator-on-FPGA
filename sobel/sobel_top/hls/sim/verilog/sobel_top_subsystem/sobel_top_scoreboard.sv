...
//
//==============================================================
`ifndef SOBEL_TOP_SCOREBOARD__SV                                                       
    `define SOBEL_TOP_SCOREBOARD__SV                                                   
                                                                                               
    `define AUTOTB_TVOUT_out_stream_out_stream_TDATA_wrapc  "../tv/rtldatafile/rtl.sobel_top.autotvout_out_stream_V_data_V.dat"
    `define AUTOTB_TVOUT_out_stream_out_stream_TKEEP_wrapc  "../tv/rtldatafile/rtl.sobel_top.autotvout_out_stream_V_keep_V.dat"
    `define AUTOTB_TVOUT_out_stream_out_stream_TSTRB_wrapc  "../tv/rtldatafile/rtl.sobel_top.autotvout_out_stream_V_strb_V.dat"
    `define AUTOTB_TVOUT_out_stream_out_stream_TUSER_wrapc  "../tv/rtldatafile/rtl.sobel_top.autotvout_out_stream_V_user_V.dat"
    `define AUTOTB_TVOUT_out_stream_out_stream_TLAST_wrapc  "../tv/rtldatafile/rtl.sobel_top.autotvout_out_stream_V_last_V.dat"
    `define AUTOTB_TVOUT_out_stream_out_stream_TID_wrapc  "../tv/rtldatafile/rtl.sobel_top.autotvout_out_stream_V_id_V.dat"
    `define AUTOTB_TVOUT_out_stream_out_stream_TDEST_wrapc  "../tv/rtldatafile/rtl.sobel_top.autotvout_out_stream_V_dest_V.dat"
    ...
    `define STREAM_SIZE_OUT_out_stream_out_stream_TUSER  "../tv/stream_size/stream_size_out_out_stream_V_user_V.dat"
    `define STREAM_SIZE_OUT_out_stream_out_stream_TLAST  "../tv/stream_size/stream_size_out_out_stream_V_last_V.dat"
    `define STREAM_SIZE_OUT_out_stream_out_stream_TID  "../tv/stream_size/stream_size_out_out_stream_V_id_V.dat"
    `define STREAM_SIZE_OUT_out_stream_out_stream_TDEST  "../tv/stream_size/stream_size_out_out_stream_V_dest_V.dat"
                                                                                               
    class sobel_top_scoreboard extends uvm_component;                                        
        ...
        int write_file_done_out_stream_out_stream_TUSER;                                                          
        int write_file_done_out_stream_out_stream_TLAST;                                                          
        int write_file_done_out_stream_out_stream_TID;                                                          
        int write_file_done_out_stream_out_stream_TDEST;                                                          
        ...
        int write_section_done_out_stream_out_stream_TUSER = 0;                                                   
        int write_section_done_out_stream_out_stream_TLAST = 0;                                                   
        int write_section_done_out_stream_out_stream_TID = 0;                                                   
        int write_section_done_out_stream_out_stream_TDEST = 0;                                                   
                                                                                           
        file_agent_pkg::file_read_agent#(32) file_rd_TVOUT_transaction_size;               
                                                                                           
        file_agent_pkg::file_write_agent#(8) file_wr_port_out_stream_out_stream_TDATA;
        file_agent_pkg::file_write_agent#(1) file_wr_port_out_stream_out_stream_TKEEP;
        file_agent_pkg::file_write_agent#(1) file_wr_port_out_stream_out_stream_TSTRB;
        ...
        file_agent_pkg::file_write_agent#(1) file_wr_port_out_stream_out_stream_TID;
        file_agent_pkg::file_write_agent#(1) file_wr_port_out_stream_out_stream_TDEST;
                                                                                               
        `uvm_component_utils_begin(sobel_top_scoreboard)                                     
        ...
        `uvm_field_object(file_wr_port_out_stream_out_stream_TUSER, UVM_DEFAULT)
        `uvm_field_int(write_file_done_out_stream_out_stream_TUSER, UVM_DEFAULT)
        `uvm_field_int(write_section_done_out_stream_out_stream_TUSER, UVM_DEFAULT)
        ...
        `uvm_field_object(file_wr_port_out_stream_out_stream_TID, UVM_DEFAULT)
        `uvm_field_int(write_file_done_out_stream_out_stream_TID, UVM_DEFAULT)
        `uvm_field_int(write_section_done_out_stream_out_stream_TID, UVM_DEFAULT)
        `uvm_field_object(file_wr_port_out_stream_out_stream_TDEST, UVM_DEFAULT)
        `uvm_field_int(write_file_done_out_stream_out_stream_TDEST, UVM_DEFAULT)
        `uvm_field_int(write_section_done_out_stream_out_stream_TDEST, UVM_DEFAULT)
        `uvm_component_utils_end                                                               
                                                                                               
        virtual function void build_phase(uvm_phase phase);                                    
            if (!uvm_config_db #(sobel_top_reference_model)::get(this, "", "refm", refm))
            ...
            file_wr_port_out_stream_out_stream_TDATA = file_agent_pkg::file_write_agent#(8)::type_id::create("file_wr_port_out_stream_out_stream_TDATA", this);
            file_wr_port_out_stream_out_stream_TKEEP = file_agent_pkg::file_write_agent#(1)::type_id::create("file_wr_port_out_stream_out_stream_TKEEP", this);
            file_wr_port_out_stream_out_stream_TSTRB = file_agent_pkg::file_write_agent#(1)::type_id::create("file_wr_port_out_stream_out_stream_TSTRB", this);
            ...
            file_wr_port_out_stream_out_stream_TID = file_agent_pkg::file_write_agent#(1)::type_id::create("file_wr_port_out_stream_out_stream_TID", this);
            file_wr_port_out_stream_out_stream_TDEST = file_agent_pkg::file_write_agent#(1)::type_id::create("file_wr_port_out_stream_out_stream_TDEST", this);
        endfunction                                                                            
        ...
        function new (string name = "", uvm_component parent = null);                        
            ...
            write_file_done_out_stream_out_stream_TUSER = 0;                                                          
            write_file_done_out_stream_out_stream_TLAST = 0;                                                          
            write_file_done_out_stream_out_stream_TID = 0;                                                          
            write_file_done_out_stream_out_stream_TDEST = 0;                                                          
        endfunction                                                                            
        ...
        virtual task run_phase(uvm_phase phase);                                               
            ...
            create_TVOUT_transaction_size_queue_by_file(`STREAM_SIZE_OUT_out_stream_out_stream_TUSER);
            file_wr_port_out_stream_out_stream_TUSER.config_file(   
                    `AUTOTB_TVOUT_out_stream_out_stream_TUSER_wrapc,
                    TVOUT_transaction_size_queue                            
                );                                                          
            ...
            create_TVOUT_transaction_size_queue_by_file(`STREAM_SIZE_OUT_out_stream_out_stream_TID);
            file_wr_port_out_stream_out_stream_TID.config_file(   
                    `AUTOTB_TVOUT_out_stream_out_stream_TID_wrapc,
                    TVOUT_transaction_size_queue                            
                );                                                          
                                                                            
            create_TVOUT_transaction_size_queue_by_file(`STREAM_SIZE_OUT_out_stream_out_stream_TDEST);
            file_wr_port_out_stream_out_stream_TDEST.config_file(   
                    `AUTOTB_TVOUT_out_stream_out_stream_TDEST_wrapc,
                    TVOUT_transaction_size_queue                            
                );                                                          
            ...
            fork                                                                               
                ...
                forever begin
                    ...
                    file_wr_port_out_stream_out_stream_TUSER.receive_ap_done();
                    file_wr_port_out_stream_out_stream_TLAST.receive_ap_done();
                    file_wr_port_out_stream_out_stream_TID.receive_ap_done();
                    file_wr_port_out_stream_out_stream_TDEST.receive_ap_done();
                end                                                                            
                begin                                                                          
                    @refm.finish;                                                              
                    ...
                    file_wr_port_out_stream_out_stream_TUSER.wait_write_file_done();
                    file_wr_port_out_stream_out_stream_TLAST.wait_write_file_done();
                    file_wr_port_out_stream_out_stream_TID.wait_write_file_done();
                    file_wr_port_out_stream_out_stream_TDEST.wait_write_file_done();
                end                                                                            
                begin                                                                      
                    forever begin                                                              
                        wait(write_section_done_out_stream_out_stream_TDATA && write_section_done_out_stream_out_stream_TKEEP && write_section_done_out_stream_out_stream_TSTRB && write_section_done_out_stream_out_stream_TUSER && write_section_done_out_stream_out_stream_TLAST && write_section_done_out_stream_out_stream_TID && write_section_done_out_stream_out_stream_TDEST);                          
                        ...
                        write_section_done_out_stream_out_stream_TUSER = 0;                                               
                        write_section_done_out_stream_out_stream_TLAST = 0;                                               
                        write_section_done_out_stream_out_stream_TID = 0;                                               
                        write_section_done_out_stream_out_stream_TDEST = 0;                                               
        ...
        virtual function void write_svr_master_in_stream(svr_transfer#(14) tr);
            `uvm_info(this.get_full_name(), "port in_stream collected one pkt", UVM_DEBUG);          
        endfunction
                   
        virtual function void write_svr_slave_out_stream(svr_transfer#(14) tr);
            `uvm_info(this.get_full_name(), "port out_stream collected one pkt", UVM_DEBUG);          
            file_wr_port_out_stream_out_stream_TDATA.write_TVOUT_data(tr.data[7: 0]);
            ...
            file_wr_port_out_stream_out_stream_TKEEP.write_TVOUT_data(tr.data[8: 8]);
            ...
            file_wr_port_out_stream_out_stream_TSTRB.write_TVOUT_data(tr.data[9: 9]);
            ...
            file_wr_port_out_stream_out_stream_TUSER.write_TVOUT_data(tr.data[10: 10]);
            ...
            file_wr_port_out_stream_out_stream_TLAST.write_TVOUT_data(tr.data[11: 11]);
            ...
            file_wr_port_out_stream_out_stream_TID.write_TVOUT_data(tr.data[12: 12]);
            write_file_done_out_stream_out_stream_TID = file_wr_port_out_stream_out_stream_TID.is_write_file_done();
            write_section_done_out_stream_out_stream_TID = file_wr_port_out_stream_out_stream_TID.is_write_section_done();
            if(write_section_done_out_stream_out_stream_TID) 
                `uvm_info("out_stream rx data done", "signal name:out_stream_TID", UVM_MEDIUM)
            file_wr_port_out_stream_out_stream_TDEST.write_TVOUT_data(tr.data[13: 13]);
            write_file_done_out_stream_out_stream_TDEST = file_wr_port_out_stream_out_stream_TDEST.is_write_file_done();
            write_section_done_out_stream_out_stream_TDEST = file_wr_port_out_stream_out_stream_TDEST.is_write_section_done();
            if(write_section_done_out_stream_out_stream_TDEST) 
                `uvm_info("out_stream rx data done", "signal name:out_stream_TDEST", UVM_MEDIUM)
        endfunction
