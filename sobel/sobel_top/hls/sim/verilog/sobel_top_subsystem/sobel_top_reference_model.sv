...
`ifndef SOBEL_TOP_REFERENCE_MODEL_SV
`define SOBEL_TOP_REFERENCE_MODEL_SV

class sobel_top_reference_model extends uvm_component;
`define TV_IN_width "../tv/cdatafile/c.sobel_top.autotvin_width.dat"
`define TV_OUT_width ""
`define TV_IN_height "../tv/cdatafile/c.sobel_top.autotvin_height.dat"
`define TV_OUT_height ""
    ...
    `uvm_component_utils_begin(sobel_top_reference_model)
