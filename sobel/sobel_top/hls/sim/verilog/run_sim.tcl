...
if {[file isfile sobel_top.autotvin.dat]} {
	file delete -force sobel_top.autotvin.dat
}

if {[file isfile sobel_top.autotvout.dat]} {
	file delete -force sobel_top.autotvout.dat
}
