...
architecture behav of sobel_top is 
    ...
    signal grp_sobel_core_fu_84_ap_ready : STD_LOGIC;
    signal grp_sobel_core_fu_84_in_stream_TREADY : STD_LOGIC;
    signal grp_sobel_core_fu_84_out_stream_TDATA : STD_LOGIC_VECTOR (7 downto 0);
    signal grp_sobel_core_fu_84_out_stream_TVALID : STD_LOGIC;
    signal grp_sobel_core_fu_84_out_stream_TREADY : STD_LOGIC;
    signal grp_sobel_core_fu_84_out_stream_TKEEP : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_sobel_core_fu_84_out_stream_TSTRB : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_sobel_core_fu_84_out_stream_TUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_sobel_core_fu_84_out_stream_TLAST : STD_LOGIC_VECTOR (0 downto 0);
    ...
    component sobel_top_sobel_core IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
    ...
    component sobel_top_CTRL_s_axi IS
    generic (
    ...
    component sobel_top_regslice_both IS
    generic (
        DataWidth : INTEGER );
    port (
        ap_clk : IN STD_LOGIC;
...
begin
    grp_sobel_core_fu_84 : component sobel_top_sobel_core
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    regslice_both_in_stream_V_data_V_U : component sobel_top_regslice_both
    generic map (
        DataWidth => 8)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_in_stream_V_keep_V_U : component sobel_top_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_in_stream_V_strb_V_U : component sobel_top_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_in_stream_V_user_V_U : component sobel_top_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_in_stream_V_last_V_U : component sobel_top_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_in_stream_V_id_V_U : component sobel_top_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_in_stream_V_dest_V_U : component sobel_top_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_out_stream_V_data_V_U : component sobel_top_regslice_both
    generic map (
        DataWidth => 8)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_out_stream_V_keep_V_U : component sobel_top_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_out_stream_V_strb_V_U : component sobel_top_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_out_stream_V_user_V_U : component sobel_top_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_out_stream_V_last_V_U : component sobel_top_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_out_stream_V_id_V_U : component sobel_top_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_out_stream_V_dest_V_U : component sobel_top_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    grp_sobel_core_fu_84_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                grp_sobel_core_fu_84_ap_start_reg <= ap_const_logic_0;
            else
                if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
                    grp_sobel_core_fu_84_ap_start_reg <= ap_const_logic_1;
                elsif ((grp_sobel_core_fu_84_ap_ready = ap_const_logic_1)) then 
                    grp_sobel_core_fu_84_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((grp_sobel_core_fu_84_out_stream_TVALID = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, grp_sobel_core_fu_84_ap_done, ap_CS_fsm_state3, ap_CS_fsm_state4, regslice_both_out_stream_V_data_V_U_apdone_blk)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state3 => 
                if (((grp_sobel_core_fu_84_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then
    ...
    ap_ST_fsm_state3_blk_assign_proc : process(grp_sobel_core_fu_84_ap_done)
    begin
        if ((grp_sobel_core_fu_84_ap_done = ap_const_logic_0)) then 
    ...
    grp_sobel_core_fu_84_ap_start <= grp_sobel_core_fu_84_ap_start_reg;
    grp_sobel_core_fu_84_out_stream_TREADY <= (out_stream_TREADY_int_regslice and ap_CS_fsm_state3);
    in_stream_TREADY <= regslice_both_in_stream_V_data_V_U_ack_in;

    in_stream_TREADY_int_regslice_assign_proc : process(grp_sobel_core_fu_84_in_stream_TREADY, ap_CS_fsm_state3)
    begin
    ...
    out_stream_TDATA_int_regslice_assign_proc : process(grp_sobel_core_fu_84_out_stream_TDATA, grp_sobel_core_fu_84_out_stream_TVALID, ap_CS_fsm_state3, out_stream_TDATA_reg)
    begin
        if (((grp_sobel_core_fu_84_out_stream_TVALID = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    out_stream_TDEST_int_regslice_assign_proc : process(grp_sobel_core_fu_84_out_stream_TVALID, grp_sobel_core_fu_84_out_stream_TDEST, ap_CS_fsm_state3, out_stream_TDEST_reg)
    begin
        if (((grp_sobel_core_fu_84_out_stream_TVALID = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    out_stream_TID_int_regslice_assign_proc : process(grp_sobel_core_fu_84_out_stream_TVALID, grp_sobel_core_fu_84_out_stream_TID, ap_CS_fsm_state3, out_stream_TID_reg)
    begin
        if (((grp_sobel_core_fu_84_out_stream_TVALID = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    out_stream_TKEEP_int_regslice_assign_proc : process(grp_sobel_core_fu_84_out_stream_TVALID, grp_sobel_core_fu_84_out_stream_TKEEP, ap_CS_fsm_state3, out_stream_TKEEP_reg)
    begin
        if (((grp_sobel_core_fu_84_out_stream_TVALID = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    out_stream_TLAST_int_regslice_assign_proc : process(grp_sobel_core_fu_84_out_stream_TVALID, grp_sobel_core_fu_84_out_stream_TLAST, ap_CS_fsm_state3, out_stream_TLAST_reg)
    begin
        if (((grp_sobel_core_fu_84_out_stream_TVALID = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    out_stream_TSTRB_int_regslice_assign_proc : process(grp_sobel_core_fu_84_out_stream_TVALID, grp_sobel_core_fu_84_out_stream_TSTRB, ap_CS_fsm_state3, out_stream_TSTRB_reg)
    begin
        if (((grp_sobel_core_fu_84_out_stream_TVALID = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    out_stream_TUSER_int_regslice_assign_proc : process(grp_sobel_core_fu_84_out_stream_TVALID, grp_sobel_core_fu_84_out_stream_TUSER, ap_CS_fsm_state3, out_stream_TUSER_reg)
    begin
        if (((grp_sobel_core_fu_84_out_stream_TVALID = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    out_stream_TVALID_int_regslice <= grp_sobel_core_fu_84_out_stream_TVALID;
end behav;
